...
mod tests {
    ...
    fn display_governs_format_pr_status_all_entry_shows_tasks_inline() {
        ...
        let out = crate::display::format_pr_status_all_entry("", 7, "My PR", &tasks, "", None, false, false, false);
    ...
    fn display_governs_format_pr_status_all_entry_shows_ready_when_no_tasks() {
        let out = crate::display::format_pr_status_all_entry("", 3, "Clean PR", &[], "", None, false, false, false);
    ...
    fn display_governs_format_pr_status_all_entry_respects_prefix() {
        ...
        let out = crate::display::format_pr_status_all_entry("  └─ ", 4, "Child PR", &tasks, "", None, false, false, false);
    ...
    #[test]
    fn display_governs_format_pr_status_all_entry_shows_draft_tag() {
        let out = crate::display::format_pr_status_all_entry("", 4, "Draft PR", &[], "", None, false, false, true);
        assert!(out.contains("[draft]"), "must show [draft] tag when draft=true, got: {}", out);
    }

    #[test]
    fn display_governs_format_pr_status_all_entry_no_draft_tag_when_not_draft() {
        let out = crate::display::format_pr_status_all_entry("", 5, "Ready PR", &[], "", None, false, false, false);
        assert!(!out.contains("[draft]"), "must not show [draft] tag when draft=false, got: {}", out);
    }

    #[test]
    fn display_governs_format_pr_status_all_entry_shows_closed_tag() {
        let out = crate::display::format_pr_status_all_entry("", 5, "Old PR", &[], "", None, true, false, false);
    ...
    fn display_governs_format_pr_status_all_entry_shows_merged_tag() {
        let out = crate::display::format_pr_status_all_entry("", 6, "Done PR", &[], "", None, false, true, false);
    ...
    fn display_governs_format_pr_status_all_entry_no_tag_when_open() {
        let out = crate::display::format_pr_status_all_entry("", 7, "Open PR", &[], "", None, false, false, false);
